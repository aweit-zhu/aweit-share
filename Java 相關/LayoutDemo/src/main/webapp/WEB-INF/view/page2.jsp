...
<div class="w-100 h-100" style="padding-top:5rem">
    <div class="d-flex flex-column flex-lg-row justify-content-center mx-5 align-items-center" >
    	<form class="row g-3 needs-validation col-12 col-lg-6" novalidate action="./page2"  method="post" enctype="multipart/form-data">
		  ...
		  <!-- 下拉選單 -->
		  <div>
		    <label for="type" class="form-label">假別</label>
		  ...
		  <div class="mb-3">
			  <label class="btn btn-outline-primary w-100">
                <input type="file" name="upfile[]" id="upfile" multiple 
                  class="upfile d-none" accept=".jpg, .jpeg, .png, .gif" required> 上傳檔案
		...
		<div id='calendar' class="mx-5 flex-shrink-0 flex-frow-0 border border-white"></div>
    </div>   
</div>
