...
/**
 * 參考文檔：(1) https://cloud.tencent.com/developer/article/2347147 (2) https://www.docs4dev.com/docs/zh/log4j2/2.x/all/manual-index.html  
 ...
 * 3. Level：trace、debug、info、warn、error
 */
